...
/**
 * Configuration for Springdoc OpenAPI and Swagger UI documentation.
 */
@Configuration
public class OpenApiConfig {
    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI().info(new Info().title("Worksuite Identity & User Service API").version("v1.0")
                .description("REST API documentation for Authentication, User Management, and Licensing."))
